...
"""
We need an accurate list of the 80% of companies that do not use social media or that have a hard time justifying a social media presence.

Example:

1) Scrap Yard, Fiberglass, Recycling, Garbage and everything else that is not your typical restaurant, sporting events, concerts, WalMart etc...
2) This list should include everything that is NOT typical.
...
if __name__ == "__main__":
    ...
    #enter search params here:
    keyword = 'Construction Business'
    place ='Pleasantville, NJ'
